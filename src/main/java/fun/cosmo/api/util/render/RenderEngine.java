...
import fun.cosmo.api.util.shader.common.states.*;
import fun.cosmo.api.util.shader.impl.blur.Blur;
import fun.cosmo.api.util.shader.impl.blur.BlurShader;
import fun.cosmo.api.util.shader.impl.border.Border;
import fun.cosmo.api.util.shader.impl.border.BorderShader;
import fun.cosmo.api.util.shader.impl.glass.Glass;
import fun.cosmo.api.util.shader.impl.glass.GlassShader;
import fun.cosmo.api.util.shader.impl.liquid.Liquid;
import fun.cosmo.api.util.shader.impl.liquid.LiquidShader;
import fun.cosmo.api.util.shader.impl.rect.RectShader;
import fun.cosmo.api.util.shader.impl.rect.Rectangle;
import fun.cosmo.api.util.shader.impl.texture.Texture;
import fun.cosmo.api.util.shader.impl.texture.TextureShader;
