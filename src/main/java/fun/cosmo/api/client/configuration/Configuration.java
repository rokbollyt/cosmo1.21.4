...
import fun.cosmo.api.client.friend.FriendService;
import fun.cosmo.Mytheria;
import fun.cosmo.api.client.configuration.impl.ModuleConfiguration;
        ...
        try (Reader reader = new FileReader(file)) {
            ...
            if (descriptionObject.has("Friends")) {
                ...
                descriptionObject.getAsJsonArray("Friends")
                        .forEach(e -> FriendService.addFriend(e.getAsString()));
            }
            // ========================
