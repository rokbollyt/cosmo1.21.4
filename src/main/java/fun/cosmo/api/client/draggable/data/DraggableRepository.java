package fun.cosmo.api.client.draggable.data;
...
import fun.cosmo.api.util.math.MathCounter;
...
import fun.cosmo.main.ui.elements.Watermark;
import fun.cosmo.main.ui.elements.draggable.KeybindsDraggable;
import fun.cosmo.main.ui.elements.draggable.TargetDraggable;

import static net.minecraft.client.util.InputUtil.isKeyPressed;
import static fun.cosmo.api.util.math.Math.stick;
