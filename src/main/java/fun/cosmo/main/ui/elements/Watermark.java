package fun.cosmo.main.ui.elements;
...
import fun.cosmo.api.client.ClientProvider;
import fun.cosmo.api.client.draggable.Draggable;
...
import fun.cosmo.api.util.fonts.main.MsdfFont;
import fun.cosmo.api.util.media.MediaUtils;
...
import fun.cosmo.api.util.shader.impl.text.TextSystem;
import fun.cosmo.main.module.render.Interface;
import fun.cosmo.main.ui.elements.event.IRender;
import fun.cosmo.mixin.accessor.BossBarHudAccessor;
...
public class Watermark extends Draggable implements IRender {
    ...
    private static Color COLOR_DEF = new Color(ColorUtil.getClientColor());
