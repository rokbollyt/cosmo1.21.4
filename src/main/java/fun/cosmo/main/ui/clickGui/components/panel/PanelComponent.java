package fun.cosmo.main.ui.clickGui.components.panel;
...
import fun.cosmo.api.util.render.ScissorUtil;
import fun.cosmo.main.ui.clickGui.Component;
import fun.cosmo.main.ui.clickGui.Helper;
import fun.cosmo.main.ui.clickGui.components.BackgroundComponent;
...
public class PanelComponent extends Component {
    ...
    @Override
    public void init() {
        componentsList = Helper.moduleLayers(category, e -> true);
    }
