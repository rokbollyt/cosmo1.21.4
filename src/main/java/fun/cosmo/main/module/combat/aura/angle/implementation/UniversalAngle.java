...
public class UniversalAngle extends AngleDeclaration {
    ...
    public static class FuntimeAngle extends AngleDeclaration {
        ...
        public Angle limitAngleChange(Angle currentAngle, Angle targetAngle, Vec3d vec3d, Entity entity) {
            ...
            moveAngle.setYaw((float) MathHelper.lerp(0.7F + fun.cosmo.api.util.math.Math.getRandom(0, 1) * 0.7F, currentAngle.getYaw(),
                    currentAngle.getYaw() + moveYaw));
            moveAngle.setPitch((float) MathHelper.lerp(0.7F + fun.cosmo.api.util.math.Math.getRandom(0, 1) * 0.7F, currentAngle.getPitch(),
